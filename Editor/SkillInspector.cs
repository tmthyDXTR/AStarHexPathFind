...
public class SkillInspector : Editor
{
    ...
    {
        ShowOnEnum("duration", Skill.Duration.OverTime.ToString(), "time"); //type1Var is only visible when type == Type1
        ShowOnEnum("form", Skill.Form.AOE.ToString(), "radius"); //type1Var is only visible when type == Type1
        ShowOnEnum("form", Skill.Form.Directional.ToString(), "radius"); //type1Var is only visible when type == Type1
        ShowOnEnum("additionalCost", Skill.AdditionalCost.Wood.ToString(), "addCost"); //type1Var is only visible when type == Type1
        ShowOnEnum("additionalCost", Skill.AdditionalCost.Fire.ToString(), "addCost"); //type1Var is only visible when type == Type1
