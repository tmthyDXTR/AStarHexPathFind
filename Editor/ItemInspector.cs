...
public class ItemInspector : Editor
{
    ...
    private void SetFieldCondition()
    {
        ...
        ShowOnEnum("effect_1", ItemManager.Effect.LightSoure.ToString(), "effect1Range"); //type1Var is only visible when type == Type1
        ShowOnEnum("effect_2", ItemManager.Effect.LightSoure.ToString(), "effect2Range"); //type1Var is only visible when type == Type1
        ShowOnEnum("effect_3", ItemManager.Effect.LightSoure.ToString(), "effect3Range"); //type1Var is only visible when type == Type1
